...
void loop()
{
  ...
  if (sum == 6000){
    Serial.println("SSSSSSSSSSTTTTTTTTTTOOOOOOOOOOOOOOOOOOOPPPPPPPPPPPPPPPPP");
    m1Speed = 0;
    m2Speed = 0;
  }
  if (sum < 40){
...
//Entre 4500 - 2600 tourner a droite
//Entre 0 - 2400 tourner a gauche   faire un pourcentage
